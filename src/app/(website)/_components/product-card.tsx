        ...
        >
          <h3
            className={cn(
              ...
              compact
                ...
                : "text-[30px] leading-none md:text-[32px]"
            )}
          >
            {product.name}
          </h3>
          ...
          <div
            className={cn(
              ...
              compact ? "mt-2 text-[18px] leading-none" : "mt-3 text-[22px] leading-none"
            )}
          >
          ...
          <div className={cn("flex items-center gap-2", compact ? "mt-3" : "mt-4")}>
            ...
            >
              <ShoppingCart className={cn("mr-1.5", compact ? "h-3 w-3" : "h-3.5 w-3.5")} />
              Add To Cart
            </Button>
          </div>
        </div>
